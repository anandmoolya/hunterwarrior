...
function draw() {
  ...
  if(gameState === 2){
    ...
    fill("yellow")
    text("story",20,50)
    text("There is fighting between warrior and monster ",50,100)
    text(" so story is that befor 100,200BC there",50,150)
    text("is king his city name is mumbai in that city all",50,200)
    text(" people are very happy but one ",50,250)
    text("day monsters  attacked the city and started harassing",50,300)
    text(" the innocent people the notice get to king so king ",50,350)
    text("start fight with monster to save his citizen",50,400)
